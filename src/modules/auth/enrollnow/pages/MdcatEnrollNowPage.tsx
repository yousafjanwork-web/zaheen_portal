...
import image from '@/assets/images/mdcat-enroll.png';
...
export function MdcatEnrollmentLandingPage() {
  ...
  return (
    <section className="w-full max-w-7xl mx-auto px-4 md:px-8 py-10 md:py-16 min-h-screen flex flex-col items-center justify-center text-center">
      ...
      >
        Master the MDCAT Syllabus with <span className="text-primary italic">Zaheen</span>
      </motion.h1>
      ...
      >
        Comprehensive video lectures, daily tests, and expert mentorship.
      </motion.p>

      {/* 👇 Image placeholder — replace with your actual import */}
      <motion.div
      ...
      >
            ...
            <img alt="Zaheen MDCAT Dashboard" className="w-full h-auto object-cover block" src={image} referrerPolicy="no-referrer" />
      ...
      >
        ...
        >
          ...
          This is a mobile content subscription service. <br />This service is applicable for Zong
          users only on those mobile phones which support GPRS settings.<br />
          ...
          To unsubscribe from Zaheen,<br /> <a href="https://z.zaheen.com.pk" style={{ color: 'blue' }}>Click Here</a><br />
          or to unsubscribe from Zaheen, send Unsub to 7323
          <br />For help, send an email to support@zaheen.com.pk<br />
          For Complaints Please Call: 03 111 444 974
        </motion.p>
      </motion.div>
    </section>
  );
