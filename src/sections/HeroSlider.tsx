...
const slides = [
  {
    ...
    description:
      "Personalized learning paths for every student with video lectures, assignments, and quizzes.",
  ...
  },
  {
    ...
    description:
      "Advance your career with industry-recognized certifications in Digital Marketing, Web Development, and more.",
  ...
  return (
    <section className="relative overflow-hidden h-[600px] lg:h-[700px] group bg-gradient-to-r from-slate-900 via-slate-800 to-slate-900 text-white">
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center w-full">
              ...
              >
                <img
                  ...
                  className="rounded-3xl shadow-2xl border border-white/20 w-full object-cover aspect-[4/3]"
                />
              </motion.div>
      ...
      <div className="absolute top-1/2 left-4 -translate-y-1/2 opacity-0 group-hover:opacity-100 transition-opacity z-20">
        <button onClick={prev} className="p-3 rounded-full bg-white/20 backdrop-blur-md hover:bg-white/30">
          <ChevronLeft size={24} />
        </button>
      </div>

      <div className="absolute top-1/2 right-4 -translate-y-1/2 opacity-0 group-hover:opacity-100 transition-opacity z-20">
        <button onClick={next} className="p-3 rounded-full bg-white/20 backdrop-blur-md hover:bg-white/30">
