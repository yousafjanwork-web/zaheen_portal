  ...
  return (
    <section className="py-16 bg-yellow-50 min-h-screen">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-8 p-6 rounded-2xl bg-gradient-to-r from-emerald-100 via-blue-50 to-emerald-100 border border-blue-200 flex flex-col lg:flex-row items-start lg:items-center justify-between gap-4">
          <div>
          ...
          <div className="text-sm bg-blue-600 text-white px-4 py-2 rounded-full font-semibold">
            {isUrdu
                ...
                <div
                  ...
                  ${
                    selectedVideo?.id === video.id
                      ...
                      : "bg-white hover:bg-blue-50 hover:scale-105 border-gray-200"
                  }
