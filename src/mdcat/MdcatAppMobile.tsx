...
function AIQuizRoute({ quiz, onAttemptFinished }: {
  ...
  if (!quiz) return <Navigate to="/mdcat-mobile/ai-prep" replace />;
  return (
    <QuizSession
      quiz={quiz}
      onBack={() => navigate("/mdcat-mobile/ai-prep")}
 ...
 function QuizSessionRoute({
  ...
  return (
    <QuizSession
      quiz={fullQuiz}
      onBack={() => navigate("/mdcat-mobile/past-papers")}
      onAttemptFinished={onAttemptFinished}
...
{
    const url = ("http://localhost:8000/api/mdcat-mobile/quizzes/AddAIQuestions");
    try
    {
        ...
        element={
          <PageTransition>
            <SEO
              ...
              path="/study-notes"
            />
            <StudyNotes onSelectQuiz={handleSelectQuiz} onBack={() => navigate("/mdcat-mobile/")} />
          </PageTransition>
        }
      />
      <Route
          ...
          <PageTransition>
            ...
            {loading ? (
              ...
              <DashBoard1
                ...
                onStartGenQuiz={() => navigate("/mdcat-mobile/ai-prep")}
