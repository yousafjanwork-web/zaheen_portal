...
import MeritCalculator from './MeritCalculator';
      ...
      {[
        ...
        return (
          ...
          if (f.link.startsWith("#")) {
            document.querySelector(f.link)?.scrollIntoView({ block: "start" });
          } else {
            navigate(f.link);
          }
        }}>
          ...
          >
            <div className="flex w-14 h-14 rounded-2xl bg-white/15 items-center justify-center transition-transform duration-300 group-hover:scale-105" >
